...
const VIDEO_DATA: VideoItem[] = [
    { id: 'v1', url: '/content/Highlights-2.mp4', title: 'p1', loc: 'p1' },
    { id: 'v2', url: '/content/video9.mp4', title: 'p2', loc: 'p2' },
    { id: 'v3', url: '/content/highlight1NM.mp4', title: 'p3', loc: 'p3' },
    { id: 'v4', url: '/content/highlight2NM.mp4', title: 'p4', loc: 'p4' },
    { id: 'v5', url: '/content/video1.mp4', title: 'p5', loc: 'p5' },
    { id: 'v6', url: '/content/short1.mp4', title: 'p6', loc: 'p6' },
    { id: 'v7', url: '/content/highlight7.mp4', title: 'p7', loc: 'p7' },
    { id: 'v8', url: '/content/Highlights-3.mp4', title: 'p8', loc: 'p8' },
    { id: 'v9', url: '/content/hightlight6.mp4', title: 'p9', loc: 'p9' },
    { id: 'v10', url: '/content/short1NM.mp4', title: 'p10', loc: 'p10' },
    { id: 'v11', url: '/content/noMusic1.mp4', title: 'p11', loc: 'p11' },
    { id: 'v12', url: '/content/video3.mp4', title: 'p12', loc: 'p12' },
    { id: 'v13', url: '/content/video4.mp4', title: 'p13', loc: 'p13' },
    { id: 'v15', url: '/content/video6.mp4', title: 'p15', loc: 'p15' },
    { id: 'v16', url: '/content/video7.mp4', title: 'p16', loc: 'p16' },
    { id: 'v17', url: '/content/video8.mp4', title: 'p17', loc: 'p17' },
    { id: 'v18', url: '/content/hightlightNM3.mp4', title: 'p18', loc: 'p18' },
    { id: 'v19', url: '/content/video2.mp4', title: 'p19', loc: 'p19' },
    { id: 'v20', url: '/content/sisterVideo.mp4', title: 'p20', loc: 'p20' },
];
